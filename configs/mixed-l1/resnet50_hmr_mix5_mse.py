...
model = dict(
    ...
    convention='smpl_54',
    loss_keypoints3d=dict(type='MSELoss', loss_weight=100),
    loss_keypoints2d=dict(type='MSELoss', loss_weight=10),
    loss_vertex=dict(type='MSELoss', loss_weight=2),
...
train_pipeline = [
    ...
    dict(type='RandomOcclusion', occlusion_prob=0.8),
