...
data = dict(
    ...
    #     ann_file='pw3d_test_downsampled.npz'),
    val=dict(
        type=dataset_type,
        body_model=dict(
            type='GenderedSMPL',
        ...
        # data_prefix='data',
        # pipeline=test_pipeline,
        # ann_file='eft_lspet_test.npz'),
        dataset_name='coco',
        data_prefix='data',
        pipeline=test_pipeline,
        ann_file='eft_coco_val2.npz'),
        # dataset_name='ochuman',
        # data_prefix='data',
        # pipeline=test_pipeline,
        # ann_file='eft_ochuman_test.npz'),
        # dataset_name='pw3d',
        # data_prefix='data',
        # pipeline=test_pipeline,
...
custom_imports = dict(
    imports=['mmhuman3d.models.heads.hmr_head_multi'],
