...
# optimizer
optimizer = dict(
    backbone=dict(type='Adam', lr=2e-4),  # default 2.5e-4
    head=dict(type='Adam', lr=2e-4),  # default 2.5e-4
    disc=dict(type='Adam', lr=1e-4))
optimizer_config = dict(grad_clip=dict(max_norm=1.0))  # default None
# learning policy
